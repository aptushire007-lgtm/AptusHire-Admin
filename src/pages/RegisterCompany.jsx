...
export default function RegisterCompany() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F0] transition-colors">
      <MarketingNavbar />
      <div className="mx-auto max-w-2xl px-5 py-14 sm:px-8">
        <OnboardingSteps current={step} />
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-bold tracking-tight text-[#1A1A1A] [overflow-wrap:anywhere] sm:text-3xl">Register Your Company</h1>
