...
function QuotePair({ probe }) {
  ...
  return (
    <div className="mt-3 grid gap-2 sm:grid-cols-2">
      ...
      {answer && (
        <figure className="min-w-0 rounded-lg border border-brand-200 bg-brand-50/40 p-2.5">
  ...
  return (
    <li className="border-b border-border last:border-b-0">
      <button
        ...
        onClick={onToggle}
        aria-expanded={open}
        className="tap-target flex w-full items-center gap-3 px-1 py-3 text-left transition-colors duration-150 hover:bg-brand-50/50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600"
      >
