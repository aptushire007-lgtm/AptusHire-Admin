 ...
 */
const cardTones = {
  default: { border: "border-slate-200 dark:border-slate-800", surface: "bg-white dark:bg-slate-900" },
  brand: { border: "border-emerald-200 dark:border-emerald-900/40", surface: "surface-brand dark:bg-slate-900" },
  ember: { border: "border-amber-200 dark:border-amber-900/40", surface: "surface-ember dark:bg-slate-900" },
...
export function EmptyState({ icon: Icon, title, description, action }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-3xl border border-dashed border-slate-200 bg-white/60 px-6 py-14 text-center shadow-2xs dark:border-slate-800 dark:bg-slate-900/60">
      {Icon && (
